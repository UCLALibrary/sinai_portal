    ...
    private function getWorks()
    {
        return [
            [
                ...
                'assoc_name' => [
                    [
                        ...
                        'note' => [
                            [
                                'type' => 'assoc_name',
                                'value' => 'John Climacus\' name derives from his authorship of this work.'
                            ]
                        ]
                    ]
                ],
                'assoc_place' => [
                    [
                        'id' => 'id-for-St-Catherines-monastery',
                        'event' => 'creation',
                        'note' => [
                            [
                                'type' => 'assoc_place',
                                'value' => 'The Ladder was almost certainly composed on Mt. Sinai while John was a monk there in the 6th-7th centuries.'
                            ]
                        ]
                    ]
                ],
