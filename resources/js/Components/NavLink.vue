...
const classes = computed(() => {
    return props.active
        ? 'inline-flex items-center pt-1 border-b-2 border-sinai-red text-sm font-medium leading-5 text-gray-900 focus:outline-none focus:border-sinai-red transition duration-150 ease-in-out'
