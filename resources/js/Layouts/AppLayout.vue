        ...
        <div class="min-h-screen bg-gray-100">
            <nav class="bg-sinai-beige border-b border-gray-100">
                ...
                <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div class="flex justify-between h-16">
                        <div class="flex sm:items-center">
                            ...
                            <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                                <NavLink :href="route('resources.index', 'text-units')" :active="route().current('resources.*') && route().params.resourceName === 'text-units'">
                                    Text Units
                                </NavLink>
                            </div>
                            <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                ...
                <div :class="{'block': showingNavigationDropdown, 'hidden': ! showingNavigationDropdown}" class="sm:hidden">
                    ...
                    <div class="pt-2 pb-3 space-y-1">
                        <ResponsiveNavLink :href="route('resources.index', 'text-units')" :active="route().current('resources.*') && route().params.resourceName === 'text-units'">
                            Text Units
                        </ResponsiveNavLink>
                    </div>
                    <div class="pt-2 pb-3 space-y-1">
